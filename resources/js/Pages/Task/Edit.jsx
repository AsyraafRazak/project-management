                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit}
                            ...
                            <div >
                                ...
                                <SelectInput id="task_project_id" value={data.project_id} name="project_id" className="mt-1 block w-full" onChange={e => setData("project_id", e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput id="project_status" value={data.status} name="status" className="mt-1 block w-full" onChange={e => setData('status', e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput id="task_priority" value={data.priority} name="priority" className="mt-1 block w-full" onChange={e => setData('priority', e.target.value)}>
                            ...
                            <div className="mt-4">
                                ...
                                <SelectInput id="task_assigned_user" value={data.assigned_user_id} name="assigned_user_id" className="mt-1 block w-full" onChange={e => setData("assigned_user_id", e.target.value)}>
